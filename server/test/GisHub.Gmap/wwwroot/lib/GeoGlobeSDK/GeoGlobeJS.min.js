...
p=this.readyState,t;h&&j&&(t=function(){p!=b.DONE&&(e(m),m.abort())},window.attachEvent("onunload",t));b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,q,r):arguments.length>3?this._object.open(a,f,j,q):this._object.open(a,f,j);try{this._object.responseType="msxms-document"}catch(s){}this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)m.readyState=m._object.readyState,d(m),m._aborted?m.readyState=b.UNSENT:(m.readyState==b.DONE&&(delete m._data,
