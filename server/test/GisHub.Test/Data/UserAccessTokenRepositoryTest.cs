...
namespace Beginor.GisHub.Test.Data {
    ...
    /// <summary>用户访问凭证仓储测试</summary>
    [TestFixture]
    public class UserAccessTokenRepositoryTest : BaseTest<IUserAccessTokenRepository> {
        ...
        public async Task _02_CanDoSearchAsync() {
            var searchModel = new UserAccessTokenSearchModel {
                Skip = 0,
                Take = 10
            };
